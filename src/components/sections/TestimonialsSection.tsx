            ...
            >
              <CarouselContent>
                {testimonials.map((testimonial, index) => (
                  <CarouselItem key={index} className="md:basis-4/5 lg:basis-3/4 pl-2 sm:pl-4">
                    <div className="p-1">
                      <TestimonialCard 
              ...
              <div className="flex justify-center gap-2 mt-4 sm:mt-6">
                <CarouselPrevious className="static size-8 sm:size-10" />
                <CarouselNext className="static size-8 sm:size-10" />
              </div>
            </Carousel>
          </div>
        </ScrollReveal>
